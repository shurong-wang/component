define(['Widget', 'jquery', 'jqueryUI'], function (Widget, $, $UI) {
	...
	// 继承 Widget 的 boudingBox, on, render, destroy
	// 实现 Widget 的 renderUI, bindUI, syncUI, destructor
	Modal.prototype = $.extend({}, new Widget(), {

		renderUI: function () {
			// 组件最外层容器，不设置则默认为 body 元素
			this.boudingBox = $(
			...
			if (this.cfg.hasCloseBtn) {
				this.boudingBox.append('<span class="window_closeBtn">×</span>');
			}
